...
<style>
    body{
        ...
        background-image: url('../static/img/crown-group.jpg');
...
<nav class="navbar navbar-expand-lg navbar-light ">
  ...
  <div class="row collapse navbar-collapse" id="navbarTogglerDemo03">
    ...
    <li class=" col-md-2 nav-item">
      ...
      <li class="offset-md-4 col-md-2 nav-item">
        ...
        <a class="nav-link border-right" href="./login.php"><i class="fas fa-sign-in-alt mr-2"></i>Log In</a>
			...
			<li class="col-md-2 nav-item">
        <a class="nav-link" href="./register.php"><i class="fas fa-sign-out-alt mr-2"></i>Registrarse</a>
      </li>
		</ul>
  </div>
</nav>
...
<div id="back row">
    ...
    <p>SI QUIERES REGISTRARTE COMO CLIENTE HAZ CLIC AQUÍ:  <a href="./registro_usuario.php">Registration for USERS</a> </p>
    <div class="alert alert-danger" id="mensaje_alert" class="alert-dismissible fade show"></div>
    <form lang="en" action="../scripts/registro_tienda.php" method="post" id="form_register">
        ...
        <div class="form-group">
            ...
            <input  type="phone" class="form-control" name="input_telefono" id="inputTelefono" placeholder="">
        </div>
        <div class="form-group">
	...
	$(document).ready(function(){
        ...
        $('#form_register').on('submit', function (event) {
            ...
            $validate_mail = emailIsValid($('#inputCorreo').val());
             ...
             if($('#inputnombreTienda').val() == '' || $('#inputnombreContacto').val() == '' || $('#inputApellidoContacto').val() == ''  || $('#inputCorreo').val() == '' || $('#inputContrasena').val() == '' || $('#inputTelefono').val() == '' || $('#inputDireccion1').val() == '' || $('#inputPais').prop('selectedIndex') == 0 || $('#inputCiudad').prop('selectedIndex') == 0){
