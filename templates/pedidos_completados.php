...
$select_detalle_pedidos_total = $pdo->prepare("SELECT c.PK_DetallePedido
                                        ...
                                        WHERE cli.FK_Usuario = :FK_Usuario AND c.Estado = 1
    ...
    <br>
        ...
        <div class="text-center" ><?php echo (count($lista_pedidos) == 0) ? 'No hay productos pedidos.': ""; ?> </div>
                        ...
                        <?php foreach($lista_pedidos as $detalle_pedido){ ?>
                            ...
                            <div class="row">
                            <div class="col-md-4 square container "> <img class="crop col-md-12" src="<?php echo URL_SITIO.$detalle_pedido['Imagen'] ?>" alt=""> </div>
                            <div class="col-md-8 ">
                                <div class="detail_up col-md-12 ">
                                    ...
                                    <div class="text-left row">
                                        ...
                                        <div class="text-left row">
                                                ...
                                                <form id="form_valoracion_<?php echo $detalle_pedido['PK_DetallePedido'] ?>">
                                                <?php if($detalle_pedido['Valoracion'] == 0) { ?>
                                                    <label class="text-small subtotal col-md-12" for="">Valora el articulo</label>
                                                <p class="clasificacion col-md-12">
                                                    <input  id="radio1" type="radio" name="estrellas" value="5"><!--
                                                    --><label class="estrella" onclick="valor(5, <?php echo $detalle_pedido['PK_DetallePedido'] ?>)" for="radio1">★</label><!--
                                                    --><input  id="radio2" type="radio" name="estrellas" value="4"><!--
                                                    --><label class="estrella" onclick="valor(4, <?php echo $detalle_pedido['PK_DetallePedido'] ?>)" for="radio2">★</label><!--
                                                    --><input  id="radio3" type="radio" name="estrellas" value="3"><!--
                                                    --><label class="estrella" onclick="valor(3, <?php echo $detalle_pedido['PK_DetallePedido'] ?>)"nfor="radio3">★</label><!--
                                                    --><input  id="radio4" type="radio" name="estrellas" value="2"><!--
                                                    --><label class="estrella" onclick="valor(2, <?php echo $detalle_pedido['PK_DetallePedido'] ?>)"nfor="radio4">★</label><!--
                                                    --><input  id="radio5" type="radio" name="estrellas" value="1"><!--
                                                    --><label class="estrella" onclick="valor(1, <?php echo $detalle_pedido['PK_DetallePedido'] ?>)" for="radio5">★</label>
                                                </p>
                                                <?php }else{ ?>
                                                 <p class="valoracion col-md-12">
                                                    <?php 
                                                    $cont = 1;
                                                    $ranking = $detalle_pedido['Valoracion'];

                                                    for($i = 1; $i <= 5; $i++){ 
                                                        if($cont <= $ranking){
                                                        ?>
                                                            <label for="" class="blocked orange">★</label>
                                                        <?php 
                                                        $cont+=1;
                                                        }else{?>
                                                            <label for="" class="blocked">★</label>
                                                        <?php }
                                                        
                                                    } ?>
                                                    <span class="col-md-12 text-small" for=""> Valoración del artículo</span>
                                                   <?php }?> 
...
if ($total_pages > 1) {
    if ($pagina != 1) {
        echo '<li class="page-item"><a class="page-link" href="Pedidos-Completados?pagina='.($pagina-1).'"><span aria-hidden="true">&laquo;</span></a></li>';
    }
    ...
    for ($i=1;$i<=$total_pages;$i++) {
        if ($pagina == $i) {
            ...
            echo '<li class="page-item"><a class="page-link" href="Pedidos-Completados?pagina='.$i.'">'.$i.'</a></li>';
        }
    }

    if ($pagina != $total_pages) {
        echo '<li class="page-item"><a class="page-link" href="Pedidos-Completados?pagina='.($pagina+1).'"><span aria-hidden="true">&raquo;</span></a></li>';
    }
}
echo '</ul>';
echo '</nav>';
...
<div class="modal fade modal-eliminar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div style="height:100%;margin-bottom:60px;" class="col-md-12 offset-md-0 ">
                <div class="card">
                <div class="card-body">
